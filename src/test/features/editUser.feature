Feature: User Edit Tests
  ...
  Scenario: Edit user details on User Info page
    ...
    When User clicks edit button on User Info page
    And User enter the firstname as "Sample New", lastname as "User New", lastname as "sampleusernew@canimmunize.ca"
    And User verifies user information
    And User verifies roles information
    And User verifies organizations information
    When User clicks edit button on User Info page
    And User reverts the user details
    And User verifies user information
    And User verifies roles information
    And User verifies organizations information
